...
import Header from '../../components/main/Header'; // Assuming we want a header or back button? Frontend had Header. App usually has Header.
          ...
          <VStack fullWidth align="start" justify="start" gap={24}>
            ...
            <VStack fullWidth gap={8}>
              <Typo.XL color="primary" fontWeight="bold">
                오늘의 사고 점수는 <Typo.XL color="brand" fontWeight="bold">{dummyData.summary.score}</Typo.XL>점입니다.
              </Typo.XL>
...
const styles = StyleSheet.create({
  ...
  wrongBadge: {
    paddingVertical: 2,
    paddingHorizontal: 8,
    backgroundColor: 'rgba(218, 127, 127, 0.1)', // wrong alpha 0.1
    borderRadius: 4,
  },
  typeBox: {
    backgroundColor: COLORS.background.secondary,
